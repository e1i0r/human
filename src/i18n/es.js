...
export const UI_ES = {
  ...
  note: "El mismo contador que corre el CLI.",
  format: "Formato",
  markdown: "Markdown",
  register: "Registro",
  none: "ninguno",
  ...
  undo: "Deshacer",
  placeholder: "Pega aquí el texto. Markdown o HTML.",
  waiting: "Esperando texto.",
  findings: "Hallazgos",
  noFindings: "Sin hallazgos",
  writtenAs: "escrito como",
  watched: "este registro lo vigila más que los otros",
  notThis: "No confundir con:",
  apply: "Aplicar:",
  asks: "pide",
  ...
  toDecideSub: "el patrón los señala y no los zanja",
  words: "palabras",
  sentences: "frases",
  units: "unidades",
  language: "idioma",
  metricsNote: "Estos números cuentan patrones. Si en tu página sobran o faltan, lo decides tú.",
};
